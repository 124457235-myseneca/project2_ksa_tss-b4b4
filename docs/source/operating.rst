[project2_ksa_tss-b4b4] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [project2_ksa_tss-b4b4] container is NOT running**.

.. tip::
   You must have your [project2_ksa_tss-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41391  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=37785
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=47771
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/project2_ksa_tss-b4b4-amd64
...
It can be accessed by entering: http://localhost:43491
...
.. important::
   http://localhost:37785/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:37785/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:37785/<html file>
...
[project2_ksa_tss-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/project2_ksa_tss-b4b4
...
.. important::
   solution_preprocessing_dag-project2_ksa_tss-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=47771, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44795, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42713, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41435, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41957, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42683, HPDEHOST=127.0.1.1, HPDEPORT=45635, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40647

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9244-project2_ksa_tss-b4b4,solution_preprocessing_dag-project2_ksa_tss-b4b4, python-preprocess-8723-project2_ksa_tss-b4b4,solution_preprocessing_dag-project2_ksa_tss-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
